...
const messages: Record<string, Msg> = {
  ...
  'landing.pricing.free.name': { fr: 'Gratuit', en: 'Free', ar: 'مجاني' },
  'landing.pricing.free.desc': {
    fr: 'Pour démarrer et tester Sahilley sans risque.',
    en: 'To get started and try Sahilley risk-free.',
    ar: 'للبدء وتجربة Sahilley دون مخاطرة.',
  },
  ...
  'landing.pricing.free.i1': { fr: '1 utilisateur', en: '1 user', ar: 'مستخدم واحد' },
  'landing.pricing.free.i2': { fr: '1 boutique', en: '1 shop', ar: 'متجر واحد' },
  'landing.pricing.free.i3': {
    fr: 'Jusqu’à 30 produits',
    en: 'Up to 30 products',
    ar: 'حتى 30 منتجاً',
  },
  'landing.pricing.free.i4': {
    fr: 'Ventes, caisse & stock',
    en: 'Sales, checkout & stock',
    ar: 'المبيعات والصندوق والمخزون',
  },
  'landing.pricing.free.i5': { fr: 'Reçus simples', en: 'Simple receipts', ar: 'إيصالات بسيطة' },
