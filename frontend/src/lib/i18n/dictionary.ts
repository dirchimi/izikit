...
const messages: Record<string, Msg> = {
  ...
  'common.thisWeek': { fr: 'Cette semaine', en: 'This week', ar: 'هذا الأسبوع' },
  'common.thisMonth': { fr: 'Ce mois', en: 'This month', ar: 'هذا الشهر' },
  'common.thisYear': { fr: 'Cette année', en: 'This year', ar: 'هذه السنة' },
  'common.customRange': { fr: 'Période personnalisée…', en: 'Custom range…', ar: 'فترة مخصّصة…' },
